...
<?oracle-xsl-mapper
  ...
  <mapTargets>
    <target type="XSD">
      <schema location="../xsd/person.xsd"/>
      <rootElement name="person" namespace="http://services.cap.org/interfaces/myaccount/person"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.7.0(build 130301.0647.0008) AT [SAT SEP 13 16:38:25 CDT 2014]. -->
?>
<xsl:stylesheet version="1.0" xmlns:bpws="http://schemas.xmlsoap.org/ws/2003/03/business-process/"
                ...
                xmlns:bpel="http://docs.oasis-open.org/wsbpel/2.0/process/executable" xmlns:hdr="http://services.cap.org/interfaces/header"
                xmlns:oraext="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.ExtFunc"
                xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:cp="http://services.cap.org/interfaces/myaccount/person"
                ...
                xmlns:bpmn="http://schemas.oracle.com/bpm/xpath" xmlns:ora="http://schemas.oracle.com/xpath/extension"
                xmlns:socket="http://www.oracle.com/XSL/Transform/java/oracle.tip.adapter.socket.ProtocolTranslator"
                xmlns:ldap="http://schemas.oracle.com/xpath/extension/ldap"
                exclude-result-prefixes="xsi xsl db xsd comm hdr cp bpws xp20 mhdr bpel oraext dvm hwf med ids bpm xdk xref bpmn ora socket ldap">
  <xsl:template match="/">
    <cp:person>
      <comm:PartyID>
